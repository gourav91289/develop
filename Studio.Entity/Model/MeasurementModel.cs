...
namespace com.boutique.Model
{
    ...
    public class StitchingMeasurementModel : INotifyPropertyChanged
    {
        ...
        private List<SelectedMultiPelItems> _Images = new List<SelectedMultiPelItems>();
        public List<SelectedMultiPelItems> Images
        {
            get { return _Images; }
            set
            {
        ...
        private int _StitchingItemId;
        public int StitchingItemId
        {
            get { return _StitchingItemId; }
            set
            {
                _StitchingItemId = value;
                OnPropertyChanged("StitchingItemId");
            }
        }
